        ...
        <div class="row">
          <div class="row">
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <h6 class="text-uppercase text-body text-xs font-weight-bolder mt-4">Aplicaciones</h6>
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
              ...
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    ...
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Apellido Paterno:</strong> &nbsp; {{Auth::user()->ap_paterno}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Apellido Materno:</strong> &nbsp; {{Auth::user()->ap_materno}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Carnet de Identidad:</strong> &nbsp; {{Auth::user()->ci}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Fecha de Nacimiento:</strong> &nbsp; {{Auth::user()->fecha_nac}}</li>
            ...
            <div class="col-12 mt-4">
              <div class="mb-5 ps-3">
                <h6 class="mb-1">Procesos Crediticios</h6>
              </div>
              <div class="row">
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a class="btn bg-gradient-info w-100" href="https://www.#.com/product/material-dashboard">Free Download</a>
        <a class="btn btn-outline-dark w-100" href="https://www.#.com/learning-lab/bootstrap/overview/material-dashboard">View documentation</a>
        <div class="w-100 text-center">
          ...
          <a href="httpscom/sharer/sharer.php?u=https://www.#.com/product/material-dashboard" class="btn btn-dark mb-0 me-2" target="_blank">
