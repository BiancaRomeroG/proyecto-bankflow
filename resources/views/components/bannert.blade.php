...
<aside
    ...
    <div class="collapse navbar-collapse w-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('dashboard',tenant('id'))}}">
            ...
            <li>
                ...
                <ul class="collapse nav flex-column" style="padding-left: 0.5rem" id="submenu3" data-bs-parent="#menu">
                    <div class="">
                        <li class="w-100">
                            <a href="{{route('creditos.index', tenant('id'))}}" class="nav-link "> <span class="nav-link-item ms-4">Procesos asignados</span></a>
                        </li>
                        <li class="w-100">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('profile.show', tenant('id')) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
