                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-8 mt-sm-0 mb-3">
                            ...
                            <div class="input-group mb-3b border border-gray-400 rounded-3">
                                <input name='archivo_ruta' type="file" class="form-control" id="inputGroupFile02" accept=".pdf" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="customCheckDisabled" required >
                        <label class="custom-control-label" for="customCheckDisabled">Acepta los terminos y condiciones</label>
                      </div>
