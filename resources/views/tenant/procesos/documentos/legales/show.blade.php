            ...
            <div class="card-header p-4 pb-2">
                <div class="row justify-content-between">
                    <div class="col-6 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <h4 class="text-dark" class="card-title">Documentos legales de la carpeta N° {{ $carpeta->id }}</h4>
                        <p class="mb-0">{{ __('Informacion legal del cliente') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row container-fluid" style="max-width: 100%">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    @if ($documento->formato == "GIT" || $documento->formato == "PNG" || $documento->formato == "JPG")
                        <img src="{{ $documento->archivo_ruta }}" alt="Imagen" class="mx-auto d-block m-4" width="80%" height="300px">
                    @else
