        ...
        <div class="container-fluid">
            <div class="card mb-4">
                <div class="card-header mb-0 pt-3 pb-2">
                    ...
                    <h5 class="font-weight-bolder" style="display: inline-block">&nbsp;&nbsp; Agregando requisito a {{ $tipo->nombre }}</h5>
                </div>
                <hr class="m-0">
                <div class="card-body mt-0 pt-0">
                    <form method="POST" action="{{ route('requisitos.store', tenant('id')) }}">
                        @csrf
                        <div class="row mt-3">
                            <input type="hidden" name="id_tipo_credito" value={{ $tipo->id }}>
