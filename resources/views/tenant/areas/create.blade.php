            ...
            <div class="card-header p-4 pb-2">
                <div class="row">
                    <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                        <h4 class="text-dark" class="card-title">Crear Areas</h4>
                    </div>
                </div>
            </div>
            <hr class="m-0">
                    ...
                    <form method="POST" action="{{ route('areas.store', tenant('id')) }}">
                        ...
                        <div>
                            ...
                            <div class="input-group input-group-static my-2">
                                ...
                                <textarea class="multisteps-form__input form-control" name = "descripcion" placeholder="" id="floatingTextarea2" style="height: 80px"></textarea>
