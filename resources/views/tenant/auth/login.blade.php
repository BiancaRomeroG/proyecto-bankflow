                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('login.in.tenant', tenant('id'))}}">
                                    ...
                                    {{--  <p class="mt-4 text-sm text-center">
                                        ...
                                        <a href="{{ route('register', tenant('id')) }}" class="text-info font-weight-bold">Únete</a>
                                    </p>  --}}
                                </form>
                            </div>
                        </div>
...
{{-- <div class="flex items-center justify-end mt-4">
    @if (Route::has('password.request'))
        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('password.request.tenant',tenant('id')) }}">
