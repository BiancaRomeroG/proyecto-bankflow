        ...
        <div class="card mb-4">
            ...
            <div class="card-body mt-0 pt-0">
                <form method="POST" action="{{ route('empresas.update', $empresa) }}">
                    @csrf
                    @method('put')
                    <input hidden type="text" name="id" value="{{ $empresa->id }}">
                    <div class="row mt-3">
                        ...
                        <div class="col-6 col-sm-4 mt-sm-0 mb-3">
                            <div class="input-group input-group-static my-2">
                                ...
                                <input name="cant_trabajadores" class="form-control" type="number"
                                    value="{{ $empresa->cant_trabajadores }}" required/>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 mt-sm-0 mb-3">
                        ...
                        <div class="button-row d-flex mt-4 d-md-flex justify-content-md-end">
                            <button class="btn bg-gradient-dark mb-0 js-btn-prev" type="submit" title="Editar Empresa">
                                Editar
                            </button>
                        </div>
                    </div>
